...
namespace Microsoft.MixedReality.Toolkit.SDK.Input.Handlers
{
    ...
    public class DraggingCtr : BaseFocusHandler,
        ...
        IMixedRealitySourceStateHandler
    {
        ...
        [SerializeField]
        public bool MoveZPoseByScrolling = true;
        [SerializeField]
        bool IsInputPoseChanging = false;
        ...
        private float scrollingSpeed = 0.2f;
        /// <summary>
        ...
        void Update()
        {
            if (MoveZPoseByScrolling && isDraggingEnabled && isDragging)
            {
               var zpos = hostTransform.position.z;
               zpos += GetMouseScrollDelta();
               hostTransform.position = new Vector3(hostTransform.position.x, hostTransform.position.y, zpos);
            }
        }
        ...
        private void StartDragging(Vector3 initialDraggingPosition)
        {
            ...
            Debug.Log(currentPointer.IsFocusLocked);
        ...
        void IMixedRealityInputHandler<MixedRealityPose>.OnInputChanged(InputEventData<MixedRealityPose> eventData)
        {
            ...
            else
            {
                ...
                if (MoveZPoseByScrolling)
                {
                    stickLength += GetMouseScrollDelta();
                }
            ...
            //newPosition = Vector3.Lerp(newPosition, GetZDelta(newPosition), positionLerpSpeed);
        ...
        float GetMouseScrollDelta() {
            return UnityEngine.Input.GetAxis("Mouse ScrollWheel") * scrollingSpeed;
        }
        ...
        private bool IsPointerRayHitSelf() {
            if (currentInputSource==null || currentPointer == null) return false;
