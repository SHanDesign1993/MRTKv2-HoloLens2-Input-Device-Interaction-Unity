        ...
        IMixedRealityFocusHandler
    {
        ...
        private void AddCorners()
        {
            ...
            if ((isFlattened && (scaleHandleSlatePrefab == null)) || (scaleHandlePrefab == null))
            {
                ...
                for (int i = 0; i < boundsCorners.Length; ++i)
                {
                    ...
                    cube.transform.localScale = new Vector3(scaleHandleSize, scaleHandleSize, scaleHandleSize)*5;
        ...
        void IMixedRealityInputHandler.OnInputDown(InputEventData eventData)
        {
            if (currentPointer == null && !eventData.used)
            {
                ...
                GameObject grabbedHandle = Pointer.Result.CurrentPointerTarget;
                ...
                if (currentHandleType != HandleType.None)
                {
                    ...
                    initialPointerPosition = Pointer.Position;
