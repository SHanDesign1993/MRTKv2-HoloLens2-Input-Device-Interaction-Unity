...
namespace IATK
{
    ...
    public class CSVDataSource : DataSource
    {
        ...
        {
            get { return _data; }
            set { if (_data != value) _data = value;  }
        }
        ...
        public List<DimensionData> dimensionData = new List<DimensionData>();
        ...
        public void load(string data, DataMetadata metadataPreset)
        {
            ...
            if (loadHeaderImpl(lines))
            {
                ...
                for (int i = 0; i < DimensionCount; ++i)
                {
                    ...
                    dimensionData[i].setOriginalData(GetCol(dataArray,i));
                }
